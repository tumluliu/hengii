...
uint32_t Job::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, this->parents.size());
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_I32, this->children.size());
  ...
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING, this->app_options.size());
...
uint32_t JobFlow::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, this->jobs.size());
