...
void HpgcJobProcessor::process_get_my_requests(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("HpgcJob.get_my_requests", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "HpgcJob.get_my_requests");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "HpgcJob.get_my_requests");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "HpgcJob.get_my_requests", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "HpgcJob.get_my_requests");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "HpgcJob.get_my_requests");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "HpgcJob.get_my_requests", bytes);
  }
}
...
void HpgcJobProcessor::process_get_all_requests(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("HpgcJob.get_all_requests", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "HpgcJob.get_all_requests");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "HpgcJob.get_all_requests");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "HpgcJob.get_all_requests", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "HpgcJob.get_all_requests");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "HpgcJob.get_all_requests");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "HpgcJob.get_all_requests", bytes);
  }
}
