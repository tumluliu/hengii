            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.jobs = new ArrayList<Job>(_list44.size);
                for (int _i45 = 0; _i45 < _list44.size; ++_i45)
                {
                  Job _elem46; // required
                  _elem46 = new Job();
                  _elem46.read(iprot);
                  struct.jobs.add(_elem46);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.jobs = new ArrayList<Job>(_list49.size);
          for (int _i50 = 0; _i50 < _list49.size; ++_i50)
          {
            Job _elem51; // required
            _elem51 = new Job();
            _elem51.read(iprot);
            struct.jobs.add(_elem51);
          }
        }
        struct.setJobsIsSet(true);
      }
