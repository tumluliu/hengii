...
module JobStatus
  ...
  FAILED = 5
  NOT_EXIST = 6
  VALUE_MAP = {1 => "FINISHED", 2 => "RUNNING", 3 => "WAITING_FOR_SUBMIT", 4 => "QUEUING", 5 => "FAILED", 6 => "NOT_EXIST"}
  VALID_VALUES = Set.new([FINISHED, RUNNING, WAITING_FOR_SUBMIT, QUEUING, FAILED, NOT_EXIST]).freeze
end
