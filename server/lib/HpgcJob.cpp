...
void HpgcJobProcessor::process_start_single_job(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.start_single_job", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.start_single_job");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.start_single_job");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.start_single_job", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.start_single_job");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.start_single_job");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "HpgcJob.start_single_job", bytes);
  }
}
...
void HpgcJobProcessor::process_start(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.start", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.start");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.start");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.start", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.start");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.start");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "HpgcJob.start", bytes);
  }
}
...
void HpgcJobProcessor::process_pause(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.pause", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.pause");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.pause");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.pause", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.pause");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.pause");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "HpgcJob.pause", bytes);
  }
}
...
void HpgcJobProcessor::process_resume(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.resume", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.resume");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.resume");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.resume", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.resume");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.resume");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "HpgcJob.resume", bytes);
  }
}
...
void HpgcJobProcessor::process_cancel(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.cancel", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.cancel");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.cancel");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.cancel", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.cancel");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.cancel");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "HpgcJob.cancel", bytes);
  }
}
...
void HpgcJobProcessor::process_get_status(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("HpgcJob.get_status", callContext);
  }
  apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "HpgcJob.get_status");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "HpgcJob.get_status");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "HpgcJob.get_status", bytes);
  }
  ...
  try {
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "HpgcJob.get_status");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "HpgcJob.get_status");
  }
...
::boost::shared_ptr< ::apache::thrift::TProcessor > HpgcJobProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< HpgcJobIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< HpgcJobIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new HpgcJobProcessor(handler));
  return processor;
}
}}} // namespace
