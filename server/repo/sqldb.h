...
class SqlDb {
	public:
		...
		/* args: sql */
        virtual std::string QuerySingle(const std::string &) const = 0;
		/* args: 1:sql, 2:result list to fill */
        virtual void QueryRow(std::vector<std::string> &, const std::string &) const = 0;
        virtual void QueryColumn(std::vector<std::string> &, const std::string &) const = 0;
